...
Example usage:
    THEANO_FLAGS='floatX=float32,device=gpu4' nohup python kast_train_membranes.py &
"""
...
if __name__ == '__main__': 
    logger = logging.getLogger("train_membrane")
